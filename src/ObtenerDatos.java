 ...
 */
    public Usuario LeerNIF() {
        ...
        try {
            ...
            //comprobacion de si existe la tarjeta o no
            if (c == null) {
            ...
            if (esDNIe(atr)) {
            	//Si se pueden leer los datos
                datos = leerCertificado(ch);
                if(datos!=null)
                    
                	//Metodo que devuelve el objeto con los datos
...
/*MEtodo para poder leer los datos del DNI(Introduciendo los datos de la tarjeta) teniendo en cuenta
/las excepciones de transmision y uso del DNIE
 * 
 */
    public byte[] leerCertificado(CardChannel ch) throws CardException, CertificateException {
        ...
        do {
            ...
            final byte CLA = (byte) 0xFF;//Buscar quÃ© valor poner aquÃ­ (0xFF no es el correcto)
            final byte INS = (byte) 0xFF;//Buscar quÃ© valor poner aquÃ­ (0xFF no es el correcto)
